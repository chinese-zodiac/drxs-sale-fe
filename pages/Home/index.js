    ...
    <section id="top" className="hero has-text-centered" style={{ backgroundColor: "#09070b", minHeight: "85vh" }}>
      ...
      <div className="hero-head has-text-left pb-5 mt-0 pt-1" style={{ position: "relative", width: "100%", backgroundColor: "#09070b" }}>
        <div style={{ marginLeft: "auto", marginRight: "auto", maxWidth: "1080px" }}>
          <div className="mt-3 pb-0 mb-0" style={{ float: "left" }}>
            ...
            <p className="title ml-5 mt-4" style={{ color: "#36CCEB" }}>DRXS Private Sale</p>
            <p className="subtitle is-size-6 mr-5 " style={{ color: "#ddd" }}> Early access, DRX DAO and Network NFT (grow your DRX Network and earn rewards worth $250)</p>
          </div>
          <Web3ModalButton />
      ...
      <div className='hero-body p-0 m-0 pt-5 pb-5' style={{ color: "#ddd", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container has-text-centered">
          <h2 className="is-size-3 mt-3">PRIVATE SALE:<br /> Use <span style={{ color: "#36CCEB" }}>BNB</span> or <span style={{ color: "#32bc35" }}>STABLES</span></h2>
          <div className="p-2" style={{ maxWidth: "300px", marginLeft: "auto", marginRight: "auto" }}>
            <ul>
              ...
              <li style={{ textShadow: "0px 0px 4px black" }}>Softcap: 10000 USD</li>
          ...
          <div className='mt-6 is-inline-block'>
            <input id="amountEtherInput" name="amountEtherInput" type="number" className='mb-3 input is-normal' step="0.1" min="0" max="3"
              style={{ maxWidth: "70px", border: "solid 2px #09070b", paddingRight: "3px" }}
            ...
            <button className='is-size-6 button is-primary'
              style={{
                ...
                backgroundColor: (!!account && accountBnbBal?.gte(parseEther(depositBnbInput?.toString() ?? "0"))) ? "#36CCEB" : "#555", border: "solid 4px #36CCEB"
              }}
              onClick={() => {
          ...
          <div className='mt-6 is-inline-block ' style={{ whiteSpace: "nowrap" }}>
            ...
            <button className='is-size-6 button is-primary'
              style={{
                color: !!account ? "#09070b" : "#444",
                backgroundColor: (isApproveNeeded || (!!account && selectStableBal?.gte(parseEther(depositUsdInput?.toString() ?? "0")))) ? "#32bc35" : "#555", border: "solid 4px #32bc35"
              }}
              onClick={() => {
